...
const baseUrl = 'https://www.hi-uli.fun'
    ...
    <div class="box">
      <div class="player">
        <el-icon class="img" :size="30" @click="playMusic" v-show="!isPlay">
          <svg t="1692452358532" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5389"
            width="48" height="48">
            <path d="M772.7 217.7a32.2 32.1 0 1 0 64.4 0 32.2 32.1 0 1 0-64.4 0Z" fill="currentColor" p-id="5390"></path>
            <path
              ...
              fill="currentColor" p-id="5391"></path>
            <path
              ...
              fill="currentColor" p-id="5392"></path>
          </svg>
        </el-icon>
        <el-icon class="img" :size="30" @click="pauseMusic" v-show="isPlay">
          <svg t="1692457087810" class="icon" viewBox="0 0 1048 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
            p-id="6550" width="48" height="48">
            <path
              ...
              p-id="6551" fill="currentColor"></path>
          </svg>
        </el-icon>
      </div>
      <div class="player">
        <el-icon class="img" :size="30" @click="nextSong">
          <svg t="1692451135957" class="img" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
            p-id="4075" width="48" height="48">
            <path class="my-path"
              ...
              fill="currentColor" p-id="4076"></path>
            <path
              ...
              fill="currentColor" p-id="4077"></path>
            <path
            ...
            <path
              ...
              fill="currentColor" p-id="4079"></path>
            <path
              ...
              fill="currentColor" p-id="4080"></path>
          </svg>
        </el-icon>
      </div>
      <div class="right">
